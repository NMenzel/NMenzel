...
Senior Software Engineer from Germany focused on fullstack architecture, accessibility, AI-assisted software delivery, and smart engineering systems.

I build maintainable web applications with TypeScript, React, Next.js, Vue, Nuxt.js, Supabase, Node.js and modern engineering practices. My current focus is using GenAI tools to improve real software delivery without weakening code quality, testing, security, review standards, or team ownership. I also like to experiment & build staff with self-hosted infrastructure on my VPS
...
- Fullstack architecture with TypeScript, React, Next.js, Vue, Nuxt.js, Supabase and Node.js
